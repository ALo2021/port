...
function embedPowerBI() {
    ...
    container.innerHTML = `<iframe width="100%" height="500" src=" " frameborder="0" allowFullScreen="true"></iframe>`;
}

// Fetch data from a Python-powered API
function fetchData() {
    fetch("http://127.0.0.1:5000/users")  // Replace with your actual API
